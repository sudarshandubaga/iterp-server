...
<body style="margin:0;padding:32px 12px;background:#f4f5f7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
  <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:10px;overflow:hidden;border:1px solid #e6e8eb;">
    <div style="background:#4f46e5;padding:22px 28px;">
      <h1 style="margin:0;color:#ffffff;font-size:20px;letter-spacing:.3px;">Confirm your email</h1>
    </div>
    <div style="padding:28px;">
      ...
      <p style="margin:0 0 20px;color:#374151;font-size:15px;line-height:1.6;">
        Thanks for signing up with <strong>Iterp</strong>. Please confirm your email address to activate your account. This link expires in <strong>24 hours</strong>.
      </p>
      <p style="margin:0 0 26px;text-align:center;">
        <a href="<?= e($data['url']) ?>" style="display:inline-block;padding:13px 30px;background:#4f46e5;color:#ffffff;text-decoration:none;border-radius:6px;font-size:15px;font-weight:600;">Verify Email Address</a>
      </p>
    ...
    <div style="background:#f9fafb;padding:14px 28px;border-top:1px solid #eef0f3;">
      <p style="margin:0;color:#9ca3af;font-size:12px;">If you did not create an account, you can safely ignore this email.</p>
    </div>
  </div>
</body>
</html>